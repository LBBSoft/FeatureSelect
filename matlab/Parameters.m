...
% Last Modified by GUIDE v2.5 07-Jun-2018 01:27:49
...
g=guidata(Selection);
 para=[''];
 k=get(handles.checkbox25,'value');
 if k==1
     para=[para,' ','-s 0'];
 end
 k=get(handles.checkbox26,'value');
 if k==1
     para=[para,' ','-s 1'];
 end
 k=get(handles.checkbox27,'value');
 if k==1
     para=[para,' ','-s 2'];
 end
 k=get(handles.checkbox47,'value');
 if k==1
     para=[para,' ','-s 3'];
 end
 k=get(handles.checkbox28,'value');
 if k==1
     para=[para,' ','-s 4'];
 end
 k=get(handles.checkbox29,'value');
 if k==1
     para=[para,' ','-t 0'];
 end
 k=get(handles.checkbox30,'value');
 if k==1
     para=[para,' ','-t 1'];
 end
 k=get(handles.checkbox31,'value');
 if k==1
     para=[para,' ','-t 2'];
 end
 k=get(handles.checkbox32,'value');
 if k==1
     para=[para,' ','-t 3'];
 end
 k=get(handles.checkbox33,'value');
 if k==1
     para=[para,' ','-t 4'];
 end
 k=get(handles.checkbox34,'value');
 if k==1
     para=[para,' ','-d',' ',get(handles.edit12,'string')];
 end
 k=get(handles.checkbox35,'value');
 if k==1
     para=[para,' ','-g',' ',get(handles.edit13,'string')];
 end
 k=get(handles.checkbox36,'value');
 if k==1
     para=[para,' ','-r',' ',get(handles.edit14,'string')];
 end
 k=get(handles.checkbox37,'value');
 if k==1
     para=[para,' ','-c',' ',get(handles.edit15,'string')];
 end
 k=get(handles.checkbox38,'value');
 if k==1
     para=[para,' ','-n',' ',get(handles.edit16,'string')];
 end
 k=get(handles.checkbox39,'value');
 if k==1
     para=[para,' ','-p',' ',get(handles.edit17,'string')];
 end
 k=get(handles.checkbox40,'value');
 if k==1
     para=[para,' ','-m',' ',get(handles.edit18,'string')];
 end
 k=get(handles.checkbox41,'value');
 if k==1
     para=[para,' ','-e',' ',get(handles.edit19,'string')];
 end
 k=get(handles.checkbox42,'value');
 if k==1
     para=[para,' ','-h',' ',get(handles.edit20,'string')];
 end
 k=get(handles.checkbox43,'value');
 if k==1
     para=[para,' ','-b',' ',get(handles.edit21,'string')];
 end
 k=get(handles.checkbox44,'value');
 if k==1
     para=[para,' ','-wi',' ',get(handles.edit22,'string')];
 end
 k=get(handles.checkbox45,'value');
 if k==1
     para=[para,' ','-v',' ',get(handles.edit23,'string')];
 end
 k=get(handles.checkbox46,'value');
 if k==1
     para=[para,' ','-q'];
 end
 [a,b]=size(para);
